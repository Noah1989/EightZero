...
Doch wenn es nun geklappt hat willst du bestimmt wissen, wie diesen
Programm funktioniert. Die Zahlen bustaben kominationen,
die du gerade abgetippt hast sind Byts in Hexadezimal geschrieben.
In der Hexadezimalschreibweise gibt es 16 Ziffern.
ZU ihnen gehören die Ziffern 0-9 und die Bustaben A-F müssen
hier auch als Ziffern herhalten, so das wir ingesamt 16 Ziffern haben.
Jedes Byte hat in der Hexadezimalschreibweise zwei dieser Ziffern.
Manche Kominationen sind widerum bestimmte Zeichen zugeordnet.
Um das näher zu Verstehnen löse folgende Aufgabe:

Aufgabe 

In der Tabelle 1.2 sind in der Hexadezimalschreibweise Byte aufgeführt
die wiederum bestimmten Zeichen zugeordnet sind. Auch das Hello World
Programm besteht in der Hexadezimalschreibweise geschriebenen Bytes.
Mansche Bytes im Hello World Programm sind bestimmten Zeichen zugeordnet
und andere Bytes aus dem Programm nicht.
Finde mit Hilfe der Tabelle heraus welche Bytes bestimmte Symbole haben
und schreibe diese auf.
Findest du heraus wo der Hello, World! Text sich im Programm verbirgt?
...
Wenn du die Aufgabe richtig gelöst hast solltest du tatsächlich
in den Programm den Test Hello World! gefunden 
haben. Diese sind ganz am Ende es Programmes versteckt und zwar 
in den folgenden Byts: 48 H; 65 e; 6C l; 6C l; 6F o; 2C ,; 20 ;
77 W; 6F o; 72 r; 6C l; 64 d; 21 !



Aufgabe 2

Der Text aus dem Hello Wolrd! Programm kann natürlich auch
geändert weden. Und zwar in den du die oben aufgeführten Bytes durch
Bytes ersetzt die andere Symbole haben.
Denke dir also deinen eigenen Text aus. Dieser Text kann alles
Mögliche sein, vieleicht dein Lieblingsessen oder dein Hobby
der Name deines Haustieres oder Irgenetwas anders was dir gerade einfällt.

Lösung zur Aufgabe 2

In der Beispiellösung wurde der Text Hello World durch den Text
APFELKUCHEN SCHMECKT GUT ersetzt. Hierbei wurden nur Bytes verwendet
die als Symbole Großbuchstaben haben, du kannst aber natürlich auch
nomal Groß - und Kleinbuchstaben verwenden.
\begin{table}
\centering
\setlength{\tabcolsep}{3pt}
\texttt{
...
\caption{``APFELKUCHEN SCHMECKT GUT!'' in Maschinencode}
\label{tab:apfelkuchen}
\end{table}
